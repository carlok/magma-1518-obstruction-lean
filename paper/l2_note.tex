...
Vampire also shows that under 1518 together with left injectivity and left surjectivity, which hold in every finite 1518-magma, the four targets 47, 614, 817, 3862 are pairwise equivalent (twelve theorems), and that equationally 3862 implies the other three. Hence:
